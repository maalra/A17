...
//gasto semana 1
$resultado = $conexion->query("SELECT id, gasto, num_semana FROM gastos WHERE num_semana=1");
...
$resultado2 = $conexion->query("SELECT id, venta, num_semana FROM ventas WHERE num_semana=1");
